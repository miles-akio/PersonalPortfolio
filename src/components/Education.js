...
const Education = () => {
  ...
  return (
    <section id="education" className="py-20 px-10 bg-gray-800 text-white max-w-5xl mx-auto">
      ...
      <div className="bg-gray-900 p-6 rounded-lg flex space-x-6">
        ...
        <div className="flex-1">
          ...
          <p className="mb-2"><strong>GPA:</strong> 3.50</p>
          ...
          {expanded && (
            <div className="mt-4 text-gray-300">
              <h3 className="font-semibold mt-4">Personal Involvement</h3>
              ...
              <h3 className="font-semibold mb-2">Honors & Certificates</h3>
              <div className="flex flex-wrap gap-2 mb-4">
